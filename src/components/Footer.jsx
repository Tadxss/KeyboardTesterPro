...
export default function Footer({ isMac }) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            ...
            <a
              ...
              className="text-xl font-bold text-emerald-400 mb-2 hover:text-emerald-300 transition-colors inline-block"
            >
              Daryl John Tadeo
            </a>
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-slate-500 text-xs">Cross-platform keyboard testing made simple</p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-slate-500 text-xs">
              Version 1.0 • Optimized for {isMac ? 'macOS' : 'Windows/Linux'}
            </div>
          </div>
        </div>
      </div>

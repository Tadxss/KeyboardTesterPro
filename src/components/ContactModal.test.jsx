...
describe('ContactModal', () => {
  ...
  it('renders nothing when closed', () => {
    ...
    expect(screen.queryByText('Contact the Developer')).not.toBeInTheDocument();
  });

  it('keeps the "Contact the Developer" title', () => {
    render(<ContactModal isOpen onClose={() => {}} />);
    expect(screen.getByRole('heading', { name: 'Contact the Developer' })).toBeInTheDocument();
  });
